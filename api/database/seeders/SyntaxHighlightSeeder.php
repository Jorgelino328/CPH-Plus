...
class SyntaxHighlightSeeder extends Seeder
{
    public function run(): void
    {
        \App\Models\SyntaxHighlight::insert([
            ...
            ['label' => 'Blade (Laravel)'            , 'value' => 'blade'             ],
            ['label' => 'BNF'                        , 'value' => 'bnf'               ],
            ...
            ['label' => 'Cache Object Script'        , 'value' => 'cos'               ],
            ...
            ['label' => 'Cisco CLI'                  , 'value' => 'cisco'             ],
            ['label' => 'Clojure'                    , 'value' => 'clojure'           ],
            ['label' => 'CoffeeScript'               , 'value' => 'coffeescript'      ],
            ['label' => 'CpcdosC+'                   , 'value' => 'cpc'               ],
            ['label' => 'Crmsh'                      , 'value' => 'crmsh'             ],
            ['label' => 'Crystal'                    , 'value' => 'crystal'           ],
            ['label' => 'Cypher (Neo4j)'             , 'value' => 'cypher'            ],
            ['label' => 'D'                          , 'value' => 'd'                 ],
            ...
            ['label' => 'DTS (Device Tree)'          , 'value' => 'dts'               ],
            ...
            ['label' => 'Extempore'                  , 'value' => 'extempore'         ],
            ...
            ['label' => 'GDScript'                   , 'value' => 'godot'             ],
            ['label' => 'Gherkin'                    , 'value' => 'gherkin'           ],
            ['label' => 'Glimmer and EmberJS'        , 'value' => 'glimmer'           ],
            ['label' => 'GN for Ninja'               , 'value' => 'gn'                ],
            ['label' => 'Go'                         , 'value' => 'go'                ],
            ['label' => 'Grammatical Framework'      , 'value' => 'gf'                ],
            ...
            ['label' => 'High-level shader language' , 'value' => 'hlsl'              ],
            ['label' => 'Hy'                         , 'value' => 'hy'                ],
            ...
            ['label' => 'Maya Embedded Language'     , 'value' => 'mel'               ],
            ['label' => 'Mercury'                    , 'value' => 'mercury'           ],
            ['label' => 'mIRC Scripting Language'    , 'value' => 'mirc'              ],
            ...
            ['label' => 'Nim'                        , 'value' => 'nim'               ],
            ['label' => 'Nix'                        , 'value' => 'nix'               ],
            ['label' => 'Object Constraint Language' , 'value' => 'ocl'               ],
            ['label' => 'OCaml'                      , 'value' => 'ocaml'             ],
            ['label' => 'Objective C'                , 'value' => 'objectivec'        ],
            ['label' => 'OpenGL Shading Language'    , 'value' => 'glsl'              ],
            ['label' => 'OpenSCAD'                   , 'value' => 'openscad'          ],
            ['label' => 'Oracle Rules Language'      , 'value' => 'ruleslanguage'     ],
            ...
            ['label' => 'QML'                        , 'value' => 'qml'               ],
            ['label' => 'R'                          , 'value' => 'r'                 ],
            ['label' => 'Razor CSHTML'               , 'value' => 'cshtml'            ],
            ['label' => 'ReasonML'                   , 'value' => 'reasonml'          ],
            ['label' => 'Rebol & Red'                , 'value' => 'redbol'            ],
            ['label' => 'RenderMan RIB'              , 'value' => 'rib'               ],
            ['label' => 'RenderMan RSL'              , 'value' => 'rsl'               ],
            ['label' => 'RiScript'                   , 'value' => 'riscript'          ],
            ['label' => 'Roboconf'                   , 'value' => 'roboconf'          ],
            ['label' => 'Robot Framework'            , 'value' => 'robot'             ],
            ['label' => 'RPM spec files'             , 'value' => 'rpm-specfile'      ],
            ['label' => 'Ruby'                       , 'value' => 'ruby'              ],
            ['label' => 'Rust'                       , 'value' => 'rust'              ],
            ['label' => 'SAS'                        , 'value' => 'sas'               ],
            ['label' => 'SCSS'                       , 'value' => 'scss'              ],
            ['label' => 'SQL'                        , 'value' => 'sql'               ],
            ['label' => 'STEP Part 21'               , 'value' => 'p21'               ],
            ['label' => 'Scala'                      , 'value' => 'scala'             ],
            ['label' => 'Scheme'                     , 'value' => 'scheme'            ],
            ['label' => 'Scilab'                     , 'value' => 'scilab'            ],
            ['label' => 'Shape Expressions'          , 'value' => 'shexc'             ],
            ['label' => 'Shell'                      , 'value' => 'shell'             ],
            ['label' => 'Smali'                      , 'value' => 'smali'             ],
            ['label' => 'Smalltalk'                  , 'value' => 'smalltalk'         ],
            ['label' => 'SML'                        , 'value' => 'sml'               ],
            ['label' => 'Solidity'                   , 'value' => 'solidity'          ],
            ['label' => 'Splunk SPL'                 , 'value' => 'spl'               ],
            ['label' => 'Stan'                       , 'value' => 'stan'              ],
            ['label' => 'Stata'                      , 'value' => 'stata'             ],
            ['label' => 'Structured Text'            , 'value' => 'iecst'             ],
            ...
            ['label' => 'Test Anything Protocol'     , 'value' => 'tap'               ],
            ['label' => 'Thrift'                     , 'value' => 'thrift'            ],
            ['label' => 'TP'                         , 'value' => 'tp'                ],
            ['label' => 'Transact-SQL'               , 'value' => 'tsql'              ],
            ['label' => 'Twig'                       , 'value' => 'twig'              ],
            ['label' => 'TypeScript'                 , 'value' => 'typescript'        ],
            ['label' => 'Unicorn Rails log'          , 'value' => 'unicorn-rails-log' ],
